# Configuration for Manage Disks used by the Virtual Machines
...
terraform {
  source = "../../../../../modules/iaam/azurerm_managed_disk"
}
...
# Managed Disks must be created inside a resource group
...
# Set the input variables for the Managed Disk module
inputs = {
