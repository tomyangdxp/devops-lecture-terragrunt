...
terraform {
  source = "../../../../../modules/iaam/azurerm_application_gateway"
}
...
# Application Gateway must be created inside a resource group
...
# Set the input variables for the Application Gateway module
inputs = {
  location            = local.location
  resource_group_name = dependency.resource_group.outputs.resource_name
  environment = local.env
  public_ip_address_appg_id = dependency.public_ip.outputs.appg_id
