# Configuration for Load Balancer Backend Address Pool
...
terraform {
  source = "../../../../../modules/iaam/azurerm_lb_backend_address_pool"
}
...
# Set the input variables for the Load Balancer Backend Address Pool module
inputs = {
