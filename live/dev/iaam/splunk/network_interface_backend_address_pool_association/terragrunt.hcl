# Configuration for Load Balancer Backend Address Pool Network Interface Association
...
terraform {
  source = "../../../../../modules/iaam/azurerm_network_interface_backend_address_pool_association"
}
...
# Set the input variables for the Load Balancer Backend Address Pool Network Interface Association module
inputs = {
  network_interfaces = dependency.network_interface.outputs.nics
  lb_backend_address_pool_pool1a_id = dependency.lb_backend_address_pool.outputs.pool1a_id
