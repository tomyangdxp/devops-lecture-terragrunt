# Configuration for Network Security Group
...
terraform {
  source = "../../../../../modules/iaam/azurerm_network_security_group"
}
...
# Network Security Group must be created inside a resource group
...
# Set the input variables for the Network Security Group module
inputs = {
